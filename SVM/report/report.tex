...
\markboth{\journalname, 12/31/2018}{Sequential Minimal Optimization and stochastic gradient descent for Training Support Vector Machines}

\begin{document}
\title{
\bigskip Sequential Minimal Optimization and stochastic gradient descent for Training Support Vector Machines}
\author{Kemiao Huang, 11610728, \IEEEmembership{CSE, Southern University of Science and Technology}
\vspace{-4ex}}
\maketitle
